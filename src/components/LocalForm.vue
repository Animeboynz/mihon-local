...
<template>
  <section class="bg-gray-800 shadow-md md:rounded-2xl p-6 text-gray-300">
    <form class="flex flex-col gap-2.5" @submit.prevent="handleSubmit" autocomplete="off">
      <article class="bg-red-900 text-red-200 rounded-xl" v-if="error">
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="title" class="font-semibold text-gray-300">Title</label>
        </div>
        <div class="flex-1 flex w-full">
          <input
              ...
              type="text"
              id="title"
              class="flex-1 min-w-0 !rounded-r-none bg-gray-900 text-gray-300 border-gray-700"
              placeholder="Ex. Death Note"
          >

          <button
              type="button"
              class="rounded-l-none border-l-0 shrink-0 bg-gray-700 text-gray-300"
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="author" class="font-semibold text-gray-300">Authors</label>
        </div>
        <div class="flex-1">
          <input
              ...
              type="text"
              id="author"
              class="w-full bg-gray-900 text-gray-300 border-gray-700"
              placeholder="Ex. Tsugumi Ohba"
          >
          <p class="text-xs text-gray-500 mt-1.5 mb-1">
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="artist" class="font-semibold text-gray-300">Artists</label>
        </div>
        <div class="flex-1">
          <input
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="description" class="font-semibold text-gray-300">Description</label>
        </div>
        <div class="flex-1">
          <textarea
              v-model.trim="entry.description"
              class="w-full h-32 bg-gray-900 text-gray-300 border-gray-700"
              id="description"
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="genre" class="font-semibold text-gray-300">Genres</label>
        </div>
        <div class="flex-1">
          <input
              v-model="entry.genre"
      ...
      <div class="sm:flex gap-4">
        <div class="sm:text-right sm:w-32 shrink-0 mt-2 mb-1 sm:mb-0">
          <label for="status" class="font-semibold text-gray-300">Status</label>
        </div>
        <div class="flex-1">
          <select v-model="entry.status" id="status" class="bg-gray-900 text-gray-300 border-gray-700">
            <option
      ...
      <div class="flex items-center gap-2 pt-5 sm:pl-36">
        <button class="button-primary grow justify-center sm:grow-0 sm:justify-start bg-primary-700 text-white border-primary-700 hover:bg-primary-800" type="submit">
          Generate
        </button>
        ...
        <label class="grow sm:grow-0 sm:ml-auto">
          <input
              ...
              @change="handleFile"
          >
          <span class="button justify-center sm:justify-start bg-gray-700 text-gray-300 border-gray-700 hover:bg-gray-600">
        ...
        <button
            class="button-ghost p-2 shrink-0 bg-transparent text-gray-300"
            type="button"
            aria-label="Settings"
            title="Settings"
