  ...
  >
    <div class="fixed z-30 inset-0 flex flex-col items-center justify-center sm:py-6 sm:px-6 md:px-0 md:py-12 lg:py-16">
      ...
      <div class="relative flex flex-col justify-center w-full max-w-2xl max-h-full overflow-hidden bg-gray-800 sm:shadow-xl sm:rounded-2xl ring-1 ring-black/5">
        ...
        <section class="flex-1 min-h-0 overflow-y-auto p-6 bg-gray-800 text-gray-300">
          <div class="relative group w-full">
            <input
                class="!rounded-full text-lg w-full pl-12 bg-gray-700 text-gray-300"
                type="search"
          ...
          <RadioGroup v-model="selection" class="pt-6" v-if="results.length > 0">
            ...
            <div class="space-y-2">
              <RadioGroupOption
                  ...
                  :key="title.id"
                  :value="title"
                  class="title-option select-none bg-gray-700 border-gray-600"
                  v-slot="{ checked }"
              >
                ...
                <div class="title-data">
                  ...
                  <p class="title-authors">{{ authors(title) }}</p>
          ...
          <p v-if="searchedOnce && results.length === 0 && !loading" class="text-gray-300">
            No results found for "{{ query }}".
          </p>
        </section>
        <footer class="shrink-0 py-4 px-6 bg-gray-700 border-t border-gray-700 flex justify-end sm:justify-between items-center">
          ...
          <div class="flex gap-2">
            <button @click="close" class="text-gray-300">Cancel</button>
            <button
...
.title-option {
  @apply p-2 border border-gray-600 rounded-md flex gap-4;
  ...
  .title-format {
    @apply ml-4 text-xs text-gray-300;
  }
}
</style>
